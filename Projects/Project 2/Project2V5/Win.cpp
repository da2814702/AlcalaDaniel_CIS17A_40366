...
{
    cout << endl << currentPlayer.giveName() << " has connected 4! Game Over!" << endl;
    ...
    {
        FinalBoard << "Player " << currentPlayer.giveName() << ", with token " << currentPlayer.giveToken() <<  ", has won with this board!" << endl;
